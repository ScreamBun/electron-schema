export default {
  ...
  types: [
    ...
    ['Results', 'Map', ['{1'], '', [
      [1, 'versions', 'ArrayOf', ['[0', '*Version', 'q'], 'List of OpenC2 language versions supported by this Actuator'],
      [2, 'profiles', 'ArrayOf', ['[0', '*Nsid', 'q'], 'List of profiles supported by this Actuator'],
